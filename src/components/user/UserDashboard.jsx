...
const UserDashboard = () => {
    const { user, loading, getAllOrder } = useMyContext();

    return (
        <Layout>
            <div className=" container mx-auto px-4 py-5 lg:py-8 mt-8">
                {/* Top  */}
                <div className="top ">
                    {/* main  */}
                    <div className=" bg-blue-gray-50 py-5 rounded-xl border border-gray-100">
                        {/* image  */}
                            ...
                            return (
                                <div key={index}>
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        const { status } = order
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-blue-gray-100 md:flex-row">
                                                {/* main 3  */}
                                                <div className="w-full border-r border-blue-gray-100 bg-blue-gray-50 md:max-w-xs">
                                                    {/* left  */}
                                                    <div className="p-8">
